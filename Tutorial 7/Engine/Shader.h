...
public:
	...
	bool InitPStandard(ID3D11Device * device, WCHAR * psFilename);
	...
	bool PSetShaderParameters(ID3D11DeviceContext* context, Light* sceneLight1, ID3D11ShaderResourceView* texture1);
	void EnableShader(ID3D11DeviceContext * context);
	void EnablePShader(ID3D11DeviceContext* context);
...
private:
	...
	Microsoft::WRL::ComPtr<ID3D11PixelShader>								m_greyscalePS;
